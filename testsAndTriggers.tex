...
The gravitational wave event S250725j is a high-SNR binary black hole event that was observed by the LVK detector network at 04:09:58 UTC on 2025-07-25. S250725j was localized to a 90\% area of 18.6 $\deg^2$, meeting the alert quality criteria for a BBH event from \citet{RubinToO2024}.
...
\begin{itemize}
    \item \textbf{Exposure times}: 30 second exposures.
    \item \textbf{Epochs}: Epoch spacing as requested in \citet{RubinToO2024} (see below).
...
\begin{figure}[b!]
    ...
    \caption{Left: The skymap of S250725j, showing the localization area concentrated near (234\textdegree, \textminus35\textdegree). Right: The pointings acquired as part of the 2025-07-28 observations shown in grey circles. The area covered by the Rubin pointings covers 94\% of the LVK localization probability. Candidates reported by other observing teams using DECam are shown overplotted on the skymap.}
